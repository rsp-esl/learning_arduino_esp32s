...
//-----------------------------------------------------------------------
const char* WIFI_SSID     = "XXXXXX"; // specify the SSID 
const char* WIFI_PASSWORD = "XXXXXX";         // specify the password
//-----------------------------------------------------------------------
...
void setup() {
   ...
   tft.drawBitmap( 8, 120, bitmap, 80, 80, ILI9341_WHITE );
