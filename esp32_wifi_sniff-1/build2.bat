...
::
%ARUINO_BUILDER% -verbose -compile -logger=machine ^
  ...
  -prefs=runtime.tools.xtensa-esp32-elf-gcc.path=C:\Users\iot\AppData\Local\Arduino15\packages\esp32\tools\xtensa-esp32-elf-gcc\1.22.0-80-g6c4433a-5.2.0 ^
  -prefs=runtime.tools.xtensa-esp32-elf-gcc-1.22.0-80-g6c4433a-5.2.0.path=C:\Users\iot\AppData\Local\Arduino15\packages\esp32\tools\xtensa-esp32-elf-gcc\1.22.0-80-g6c4433a-5.2.0 ^
  -prefs=runtime.tools.mkspiffs.path=C:\Users\iot\AppData\Local\Arduino15\packages\esp32\tools\mkspiffs\0.2.3 ^
  -prefs=runtime.tools.mkspiffs-0.2.3.path=C:\Users\iot\AppData\Local\Arduino15\packages\esp32\tools\mkspiffs\0.2.3 ^
  -prefs=runtime.tools.esptool_py.path=C:\Users\iot\AppData\Local\Arduino15\packages\esp32\tools\esptool_py\2.6.0 ^
  -prefs=runtime.tools.esptool_py-2.6.0.path=C:\Users\iot\AppData\Local\Arduino15\packages\esp32\tools\esptool_py\2.6.0 ^
  %SKETCH_PATH_NAME%
::
echo "===================================="
